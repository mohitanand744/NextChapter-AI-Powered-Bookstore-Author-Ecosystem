...
import OrderCardSkeleton from "../components/Loaders/Skeleton/OrderCardSkeleton";
      ...
      <div className="min-h-screen px-4 pb-8 pt-0 sm:px-6 lg:px-8">
        <div className="container mx-auto px-4">
          ...
          <SubNavbar
            ...
            registryCount={loading ? "Loading..." : `${orders.length} ${orders.length === 1 ? 'Order' : 'Orders'} Total`}
                  ...
                  filteredOrders.map((order, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="relative overflow-hidden bg-coffee text-tan border border-tan/20 rounded-2xl shadow-xl hover:shadow-2xl z-10 hover:z-[99]"
                      >
